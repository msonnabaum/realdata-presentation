...
(function() {
  ...
  define('preso', function(require, exports, module) {
    var $, Preso, Showdown;
    Showdown = require("showdown");
    $ = require("zepto");
    return Preso = (function() {
      ...
      Preso.prototype.createSlide = function(contents) {
        var class_str, classes, div, first, id, item, slide_metadata, _i, _len;
        ...
        id || (id = classes[0] || "");
        return "<section data-state=\"" + id + "\" id=\"" + id + "\" class=\"hbox " + class_str + "\" data-markdown>" + contents + "</section>";
      };
